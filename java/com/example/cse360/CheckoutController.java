...
public class CheckoutController implements Initializable {
    ...
    public void placeOrder(ActionEvent event) throws IOException {
        ...
        if (placed) {
            ...
            loader.setLocation(getClass().getResource("delivery-order.fxml"));
            ...
            controller.deliverConstruct(order.getCount());
    ...
    public void payConstruct(double price, Order order) {
